    ...
    return (
        <div className="relative flex  flex-col items-center justify-center  px-4 md:px-16 lg:px-24 xl:px-32">
         <div className="absolute z-10 size-96  bg-pink-600/70 blur-[300px]" />
            <motion.a href="https://prebuiltui.com?utm_source=pixels" className="group flex items-center  gap-2 rounded-full p-1 pr-3 mt-35 text-pink-100 bg-pink-200/15"
            ...
            >
                <button onClick={() => navigate("/about")} className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11">
                    About Us
                </button>
